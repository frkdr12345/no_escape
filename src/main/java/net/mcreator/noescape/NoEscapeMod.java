...
import net.mcreator.noescape.init.NoEscapeModItems;
import net.mcreator.noescape.init.NoEscapeModEntities;
import net.mcreator.noescape.init.NoEscapeModBlocks;
...
public class NoEscapeMod {
	public static final Logger LOGGER = LogManager.getLogger(NoEscapeMod.class);
	public static final String MODID = "no_escape";
	...
	public NoEscapeMod() {
		...
		NoEscapeModBlocks.REGISTRY.register(bus);

		NoEscapeModItems.REGISTRY.register(bus);
		NoEscapeModEntities.REGISTRY.register(bus);
						...
						for (Field field : fields) {
							if (EditBox.class.isAssignableFrom(field.getType())) {
								try {
									...
									NoEscapeMod.LOGGER.error(exceptionAsString);
								}
							}
						}
					}
	...
	public static class initer {
		...
		public static void init(FMLCommonSetupEvent event) {
			NoEscapeMod.addNetworkMessage(TextboxSetMessage.class, TextboxSetMessage::buffer, TextboxSetMessage::new, TextboxSetMessage::handler);
		}
	}
